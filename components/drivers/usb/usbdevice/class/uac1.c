...
#define VOLUME_CUR                  0x0000 /* 0 dB*/
#define VOLUME_RES                  0x0100 /* 1 dB (1*256) */
#define VOLUME_MAX_USB              0x0000 /* 0 dB */
#define VOLUME_MIN_USB              0x9C00 /* -100 dB (-100*256) */
...
static rt_err_t _audio_playback_card_enable(struct audio_play *p)
{
    ...
    p->period_size = p->sample_rate * P_PERIOD_SIZE_MS / 1000;
