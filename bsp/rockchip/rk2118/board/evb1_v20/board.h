...
/**
* In the hardware design of the evb1v20 + ite6632x ext
* board, the i2c used for upgrading is not actually
* connected. This is just an example. Please Config
* ONFIG_RT_IT6632X_FW_UPGRADE = y, make modifications
* based on the actual hardware design and configure
* the iomux in iomux.c at the same time.
*/
#define IT6632X_ISP_ADDR         0x5c
#define IT6632X_ISP_DEV         "i2c5"
#endif
