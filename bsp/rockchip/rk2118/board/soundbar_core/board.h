...
#define IT6632X_RST_GPIO_BANK     GPIO_BANK4
#define IT6632X_RST_GPIO          GPIO_PIN_A7
#define IT6632X_RST_PIN           BANK_PIN(GPIO_BANK4, 7)
...
#define IT6632X_INT_GPIO          GPIO_PIN_B7
#define IT6632X_INT_PIN           BANK_PIN(GPIO_BANK3, 15)
...
#define IT6632X_RXMUTE_GPIO          GPIO_PIN_B6
#define IT6632X_RXMUTE_PIN           BANK_PIN(GPIO_BANK3, 14)
