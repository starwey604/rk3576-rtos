...
const struct tas5805m_board_cfg tas5805m_devices[] =
{
    ...
    { .id = 3, .i2c_bus_name = "i2c0", .i2c_addr = 0x2f },
    { .id = 4, .i2c_bus_name = "i2c3", .i2c_addr = 0x2c },
    { .id = 5, .i2c_bus_name = "i2c3", .i2c_addr = 0x2d },
    { .id = 6, .i2c_bus_name = "i2c3", .i2c_addr = 0x2e },
    { .id = 7, .i2c_bus_name = "i2c3", .i2c_addr = 0x2f },
    { .id = -1 },
};
#endif
