...
SRAM_DSP2_SIZE          = 0x0005C000; /* 368 KB */
SRAM_LOG_SIZE           = 0x00004000; /* 16 KB */
...
SRAM_LOG_BASE          = (SRAM_DSP2_BASE + SRAM_DSP2_SIZE);
SRAM_SPI2APB_BASE      = (SRAM_LOG_BASE + SRAM_LOG_SIZE);
SRAM_END               = (SRAM_SPI2APB_BASE + SRAM_SPI2APB_SIZE);

ASSERT(!(SRAM_LOG_BASE % 4096), "SRAM_LOG_BASE must be 4K aligned")
ASSERT(!(SRAM_LOG_SIZE % 4096), "SRAM_LOG_SIZE must be 4K aligned")
...
DRAM_CPU0_RTT_SIZE       =   0x00E00000; /* 14 MB */
DRAM_NPU_SIZE            =   0x00400000; /* 4 MB */
DRAM_DSP0_SIZE           =   0x01200000; /* 18 MB */
DRAM_DSP1_SIZE           =   0x00800000; /* 8 MB */
DRAM_DSP2_SIZE           =   0x01200000; /* 18 MB */
DRAM_CPU1_LOADER_SIZE    =   0x00008000; /* 32 KB */
DRAM_CPU1_RTT_SIZE       =   0x000D8000; /* 864 KB */
DRAM_LOG_SIZE            =   0x00020000; /* 128 KB */
...
DRAM_LOG_BASE            =   (DRAM_CPU1_RTT_BASE + DRAM_CPU1_RTT_SIZE);

ASSERT(!(DRAM_LOG_BASE % 4096), "DRAM_LOG_BASE must be 4K aligned")
ASSERT(!(DRAM_LOG_SIZE % 4096), "DRAM_LOG_SIZE must be 4K aligned")
