...
../tools/sign_tool/bin/boot_merger ./Image/rk2116_psram.ini
../tools/sign_tool/bin/boot_merger ./Image/rk2116_no_psram.ini
# Expand the rk2116_idb_no_ddr/rk2116_idb_psram file to 64KB and make a backup copy
#./package_idb.py Image/rk2116_idb_no_psram.img
./package_idb.py Image/rk2116_idb_psram.img
...
if [ ! -n "$1" ] ;then
    ...
    case $1 in
        *"package-file"*)
            ...
            $TOOLS/sign_tool/bin/rkImageMaker "-RK2116" $IMAGE/MiniLoaderAllPSRAM.bin $IMAGE/update.img tmp_update.img -os_type:rt-thread
