...
if PLATFORM == 'gcc':
    ...
    STRIP   = PREFIX + 'strip'
    DEVICE = ' -mtune=nuclei-300-series -march=rv32ima_zicond_zba_zbb_zbc_zbs_zca_zcb_zcmp_zcmt_xxldspn3x -mabi=ilp32 -mcmodel=medlow -DCPU_SERIES=300 -DBOOT_HARTID=0 -DRTOS_RTTHREAD -fpic -flto'
    COMMON_FLAGS = ' -g -Wall -Werror -D__RT_THREAD__ '
