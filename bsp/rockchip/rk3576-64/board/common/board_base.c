...
struct mem_desc platform_mem_desc[] =
{
    ...
    {DSMC_MEM_BASE, DSMC_MEM_BASE + 0x10000000, DSMC_MEM_BASE, NORMAL_NOCACHE_MEM}, /* DSMC HOST memory space */
#endif
...
static struct GIC_AMP_IRQ_INIT_CFG irqsConfig[] =
{
...
#endif
#ifdef RT_USING_PIN
    GIC_AMP_IRQ_CFG_ROUTE(GPIO1_IRQn, 0xd0, CPU_GET_AFFINITY(3, 0)),
    ...
    GIC_AMP_IRQ_CFG_ROUTE(GPIO1_EXP3_IRQn, 0xd0, CPU_GET_AFFINITY(3, 0)),
#endif
#endif
#ifdef RT_USING_FLEXBUS
    GIC_AMP_IRQ_CFG_ROUTE(FLEXBUS_IRQn, 0xd0, CPU_GET_AFFINITY(3, 0)),
#endif
...
#endif
#ifdef RT_USING_SPI
    GIC_AMP_IRQ_CFG_ROUTE(SPI0_IRQn, 0xd0, CPU_GET_AFFINITY(3, 0)),
#endif
...
#ifdef RT_USING_I2C7
    GIC_AMP_IRQ_CFG_ROUTE(I2C7_IRQn, 0xd0, CPU_GET_AFFINITY(3, 0)),
#endif

#ifdef RT_USING_SARADC
    GIC_AMP_IRQ_CFG_ROUTE(SARADC_IRQn, 0xd0, CPU_GET_AFFINITY(3, 0)),
#endif

#ifdef RT_USING_PWM
    GIC_AMP_IRQ_CFG_ROUTE(PWM0_CH0_IRQn, 0xd0, CPU_GET_AFFINITY(3, 0)),
    GIC_AMP_IRQ_CFG_ROUTE(PWM2_CH3_IRQn, 0xd0, CPU_GET_AFFINITY(3, 0)),
#endif
#ifdef RT_USING_HWTIMER
   GIC_AMP_IRQ_CFG_ROUTE(TIMER6_IRQn, 0xd0, CPU_GET_AFFINITY(3, 0)),
   GIC_AMP_IRQ_CFG_ROUTE(TIMER7_IRQn, 0x80, CPU_GET_AFFINITY(3, 0)),
   GIC_AMP_IRQ_CFG_ROUTE(TIMER10_IRQn, 0xd0, CPU_GET_AFFINITY(3, 0)),
#endif
