...
/** Since RK2116 does not have GPIO6 but has GPIO6_IOC for controlling psram, it
  * is necessary to undef GPIO6 in the gpio driver.
  */
#if defined(RKMCU_RK2116)
#undef GPIO6
#endif
...
#undef GPIO5_IRQn
#ifdef HAL_GPIO_VIRTUAL_GROUP_USED
#define GPIO5 VIRT_GPIO(5, HAL_GPIO_VIRTUAL_GROUP_USED)
#define GPIO5_IRQn VIRT_GPIO_IRQ(5, HAL_GPIO_VIRTUAL_GROUP_USED)
#else
#define GPIO5 GPIO5_EXP
#define GPIO5_IRQn GPIO5_EXP_IRQn
#endif
#endif
...
#undef GPIO6_IRQn
#ifdef HAL_GPIO_VIRTUAL_GROUP_USED
#define GPIO6 VIRT_GPIO(6, HAL_GPIO_VIRTUAL_GROUP_USED)
#define GPIO6_IRQn VIRT_GPIO_IRQ(6, HAL_GPIO_VIRTUAL_GROUP_USED)
#else
#define GPIO6 GPIO6_EXP
#define GPIO6_IRQn GPIO6_EXP_IRQn
#endif
#endif
...
#undef GPIO7_IRQn
#ifdef HAL_GPIO_VIRTUAL_GROUP_USED
#define GPIO7 VIRT_GPIO(7, HAL_GPIO_VIRTUAL_GROUP_USED)
#define GPIO7_IRQn VIRT_GPIO_IRQ(7, HAL_GPIO_VIRTUAL_GROUP_USED)
#else
#define GPIO7 GPIO7_EXP
#define GPIO7_IRQn GPIO7_EXP_IRQn
#endif
#endif
...
#endif
#ifdef GPIO5
void pin_gpio5_handler(void)
{
    rt_interrupt_enter();
    HAL_GPIO_IRQHandler(GPIO5, GPIO_BANK5);
    rt_interrupt_leave();
}
#endif
#ifdef GPIO6
void pin_gpio6_handler(void)
{
    rt_interrupt_enter();
    HAL_GPIO_IRQHandler(GPIO6, GPIO_BANK6);
    rt_interrupt_leave();
}
#endif
#ifdef GPIO7
void pin_gpio7_handler(void)
{
    rt_interrupt_enter();
    HAL_GPIO_IRQHandler(GPIO7, GPIO_BANK7);
    rt_interrupt_leave();
}
#endif
...
#endif
#ifdef GPIO5
    rt_hw_interrupt_install(GPIO5_IRQn, (void *)pin_gpio5_handler, RT_NULL, RT_NULL);
    rt_hw_interrupt_umask(GPIO5_IRQn);
#endif
#ifdef GPIO6
    rt_hw_interrupt_install(GPIO6_IRQn, (void *)pin_gpio6_handler, RT_NULL, RT_NULL);
    rt_hw_interrupt_umask(GPIO6_IRQn);
#endif
#ifdef GPIO7
    rt_hw_interrupt_install(GPIO7_IRQn, (void *)pin_gpio7_handler, RT_NULL, RT_NULL);
    rt_hw_interrupt_umask(GPIO7_IRQn);
#endif
