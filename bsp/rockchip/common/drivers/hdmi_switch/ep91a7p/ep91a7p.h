...
typedef enum
{
    RT_EP91A7P_PRIMARY_SEL_PORT_0,
    RT_EP91A7P_PRIMARY_SEL_PORT_1,
    RT_EP91A7P_PRIMARY_SEL_PORT_2,
    RT_EP91A7P_PRIMARY_SEL_PORT_3,
    RT_EP91A7P_PRIMARY_SEL_PORT_4,
    /* None HDMI function without Video Mute,
     * can response routing info to TV routing
     * change (TV, ARC...)
     */
    RT_EP91A7P_PRIMARY_SEL_PORT_5,
    /* None HDMI function with Video Mute cannot
     * response routing info to TV routing change
     * (Bluetooth, FM... when don't want interrupted
     * by TV)
     */
    RT_EP91A7P_PRIMARY_SEL_PORT_6, //
} ep91a7p_primary_sel_t;
...
#define EP_GC_LINK_ON3_SHIFT   3
#define EP_GC_LINK_ON3_MASK    0x08
#define EP_GC_LINK_MASK        0x0F
...
#define EP92A7E_VENDOR_ID_0           (0x17)
#define EP92A7E_VENDOR_ID_1           (0x7A)
#define EP92A7E_DEVICE_ID_0           (0x92)
#define EP92A7E_DEVICE_ID_1           (0xA7)
