...
rt_uint8_t g_rk_rpt_log_level = RK_RPT_LOG_INFO;
...
rt_err_t rk_hdmi_rpt_dbg_level_set(void *data)
{
    rt_err_t ret = -RT_ERROR;

    g_rk_rpt_log_level = *(rt_uint8_t *)data;

    return ret;
}

static char *rk_hdmi_repeat_ctl_to_str(int cmd)
{
    switch (cmd)
    {
    case RK_REPEAT_CTL_ADO_PATH_SET:
        return "RK_REPEAT_CTL_ADO_PATH_SET";
    case RK_REPEAT_CTL_ADO_PATH_GET:
        return "RK_REPEAT_CTL_ADO_PATH_GET";
    case RK_REPEAT_CTL_E_ARC_VOL_SET:
        return "RK_REPEAT_CTL_E_ARC_VOL_SET";
    case RK_REPEAT_CTL_E_ARC_VOL_GET:
        return "RK_REPEAT_CTL_E_ARC_VOL_GET";
    case RK_REPEAT_CTL_REG_ADO_CHG_HOOK:
        return "RK_REPEAT_CTL_REG_ADO_CHG_HOOK";
    case RK_REPEAT_CTL_UNREG_ADO_CHG_HOOK:
        return "RK_REPEAT_CTL_UNREG_ADO_CHG_HOOK";
    case RK_REPEAT_CTL_REG_CEC_VOL_CHG_HOOK:
        return "RK_REPEAT_CTL_REG_CEC_VOL_CHG_HOOK";
    case RK_REPEAT_CTL_UNREG_CEC_VOL_CHG_HOOK:
        return "RK_REPEAT_CTL_UNREG_CEC_VOL_CHG_HOOK";
    case RK_REPEAT_CTL_REG_RX_MUTE_HOOK:
        return "RK_REPEAT_CTL_REG_RX_MUTE_HOOK";
    case RK_REPEAT_CTL_UNREG_RX_MUTE_HOOK:
        return "RK_REPEAT_CTL_UNREG_RX_MUTE_HOOK";
    case RK_REPEAT_CTL_POWER_MODE_CTRL:
        return "RK_REPEAT_CTL_POWER_MODE_CTRL";
    case RK_REPEAT_CTL_GET_REPEAT_STATUS:
        return "RK_REPEAT_CTL_GET_REPEAT_STATUS";
    case RK_REPEAT_CTL_FW_UPDATE:
        return "RK_REPEAT_CTL_FW_UPDATE";
    default:
        return "RK_REPEAT_CTL_UNKNOWN";
    }
}
...
rt_err_t rk_hdmi_repeat_control(rt_device_t dev, int cmd, void *args)
{
    ...
    case RK_REPEAT_CTL_DBG_LEVEL:
        ret = rk_hdmi_rpt_dbg_level_set(args);
        break;
    default:
    ...
    if (ret)
    {
        rt_kprintf("rk repeat: cmd: %s err:%d\n", rk_hdmi_repeat_ctl_to_str(cmd), ret);
    }
