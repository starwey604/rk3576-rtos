...
enum sc3336_support_mode_id
{
    SC3336_320X240 = 0,
    SC3336_640X480,
    SC3336_2304X1296,
    SC3336_MODE_ID_MAX = SC3336_2304X1296,
};
extern const struct camera_board_desc camera_sc3336[];
#endif
...
#ifdef RT_USING_SC535HAI
enum sc535hai_support_mode_id
{
    SC535HAI_1296X972 = 0,
    SC535HAI_2592X1944,
    SC535HAI_MODE_ID_MAX = SC535HAI_2592X1944,
};
extern const struct camera_board_desc camera_sc535hai[];
#endif
...
enum ps5458_support_mode_id
{
    PS5458_1344X760,
    PS5458_2560X1472,
    PS5458_MODE_ID_MAX = PS5458_2560X1472,
};
extern const struct camera_board_desc camera_ps5458[];
#endif

#ifdef RT_USING_NT99436
enum nt99436_support_mode_id
{
    NT99436_1280X720,
    NT99436_2560X1440,
    NT99436_MODE_ID_MAX = NT99436_2560X1440,
};
extern const struct camera_board_desc camera_nt99436[];
#endif

#ifdef RT_USING_MIS40C1
enum mis40c1_support_mode_id
{
    MIS40C1_1280X720 = 0,
    MIS40C1_2560X1440,
    MIS40C1_MODE_ID_MAX = MIS40C1_2560X1440,
};
extern const struct camera_board_desc camera_mis40c1;
#endif
