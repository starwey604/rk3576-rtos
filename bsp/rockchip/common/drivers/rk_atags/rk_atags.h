...
#ifdef __RT_THREAD__
extern u32 __linux_share_atags_start__[];
extern u32 __linux_share_atags_end__[];
#define ATAGS_LINUX_MEM_BASE ((u32)&__linux_share_atags_start__)
#define ATAGS_LINUX_MEM_END  ((u32)&__linux_share_atags_end__)
#endif
