...
{
    if (HAL_USB_PhyBvalidIrqRiseStatus())
    {
        HAL_USB_PhyBvalidIrqRiseStatusClear();
        rt_interrupt_enter();
    ...
    else if (HAL_USB_PhyBvalidIrqFallStatus())
    {
        HAL_USB_PhyBvalidIrqFallStatusClear();
        HAL_USB_PhySuspend(g_usbd.id);
        clk_disable_by_id(g_usbdDev.hclkGateID);
        clk_disable_by_id(g_usbdDev.utmiclkGateID);
